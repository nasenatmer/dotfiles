...
" Published on Wikipedia in 2003 and declared authorless.
" 
...
"
" To do: different coloured links for non-existent and disambiguation pages.
" Plug-in support for downloading and uploading to the server.
...
" wiki formatting
syn region wikiItalic start="''" end="''" skip="<nowiki>.*</nowiki>" contains=wikiLink
syn region wikiBold start="'''" end="'''" skip="<nowiki>.*</nowiki>" contains=wikiLink
syn region wikiBoldItalic start="''''" end="''''" skip="<nowiki>.*</nowiki>" contains=wikiLink
